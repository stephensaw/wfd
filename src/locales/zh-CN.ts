export default {
  ...
  'startEvent': '开始节点',
  'startEvent.description': '这是活动开始的地方',
  'endEvent': '结束节点',
  'endEvent.description': '这是活动结束的地方',
  'start': '开始事件',
  'end': '结束事件',
  'gateway': '网关',
