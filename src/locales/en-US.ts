export default {
  ...
  'timerEvent.description': 'Timer that triggers on regular interval',
  'timerEvent.cycle': 'Cycle',
  'timerEvent.cycle.placeholder': 'Select time',
  'timerEvent.duration': 'Duration',
  'messageEvent': 'Message Event',
  'messageEvent.description': 'Triggers to send a message',
  'messageEvent.message': 'Message',
  'signalEvent': 'Signal Event',
  'signalEvent.description': 'Send a signal to starts an activity',
  ...
  'startEvent.description': 'This is where the event starts',
  'endEvent': 'End Event',
  'endEvent.description': 'This is where the event ends',
  'start': 'Start Events',
  'end': 'End Events',
  'gateway': 'Gateway',
